...
import getModuleWiseData from '@salesforce/apex/DashBoardCtrl.getModuleWiseData';
import getCourseOptions from '@salesforce/apex/DashBoardCtrl.getCourseOptions';
...
export default class ModuleLevelDashboard extends LightningElement {
    @api selectedMentor;
    @api selectedUDLabel;
    ...
    handleModuleClick(moduleLabel, chartName) {
        ...
        // Add the logic for Module Progress chart
        else if (chartName === 'moduleProgress') {
            progressKey = 'moduleProgress'; // Key for module progress
        }
    ...
    filterStudentData(progressKey) {
        ...
        if (progressKey.includes('course') || progressKey.includes('project')) {
            ...
            // For module progress, the selectedModule represents the next module (e.g., "Module 2")
    ...
    handleModuleChartClose(event) {
        this.dispatchEvent(new CustomEvent('closemodulechart'));
    }
}